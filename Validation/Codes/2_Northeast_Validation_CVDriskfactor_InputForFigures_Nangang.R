...
data_observed <- read.xlsx("/Validation/Parameters/Northeast_CVDriskFactor_ComparedWithNangang.xlsx", sheet = "original")
...
data_simulated <- read.xlsx("/Validation/Tables/Northeast_withNangang_Summary_CVDriskFactor.xlsx") 
...
write_xlsx(data_observed, "/Validation/Tables/Northeast_CVDriskFactor_ComparedWithNangang_original.xlsx")



# Read source workbook for per-sheet updates
path <- "/Validation/Parameters/Northeast_CVDriskFactor_ComparedWithNangang.xlsx"
...
write_xlsx(result_sheets, "/Validation/Tables/Northeast_CVDriskFactor_ComparedWithNangang_category.xlsx")
