...
data_observed <- read.xlsx("/Validation/Parameters/Northwest_CVDriskFactor_ComparedWithMaiji.xlsx", sheet = "original")
...
data_simulated <- read.xlsx("/Validation/Tables/Northwest_withMaiji_Summary_CVDriskFactor.xlsx") 
...
write_xlsx(data_observed, "/Validation/Tables/Northwest_CVDriskFactor_ComparedWithMaiji_original.xlsx")



# Read source workbook for per-sheet updates
path <- "/Validation/Parameters/Northwest_CVDriskFactor_ComparedWithMaiji.xlsx"
...
write_xlsx(result_sheets, "/Validation/Tables/Northwest_CVDriskFactor_ComparedWithMaiji_category.xlsx")
