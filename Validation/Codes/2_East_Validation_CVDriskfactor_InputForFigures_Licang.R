...
data_observed <- read.xlsx("/Validation/Parameters/East_CVDriskFactor_ComparedWithLicang.xlsx", sheet = "original")
...
data_simulated <- read.xlsx("/Validation/Tables/East_withLicang_Summary_CVDriskFactor.xlsx") 
...
write_xlsx(data_observed, "/Validation/Tables/East_CVDriskFactor_ComparedWithLicang_original.xlsx")



# Read source workbook for per-sheet updates
path <- "/Validation/Parameters/East_CVDriskFactor_ComparedWithLicang.xlsx"
...
write_xlsx(result_sheets, "/Validation/Tables/East_CVDriskFactor_ComparedWithLicang_category.xlsx")
