...
data_observed <- read.xlsx("/Validation/Parameters/South_CVDriskFactor_ComparedWithMeilan.xlsx", sheet = "original")
...
data_simulated <- read.xlsx("/Validation/Tables/South_withMeilan_Summary_CVDriskFactor.xlsx") 
...
write_xlsx(data_observed, "/Validation/Tables/South_CVDriskFactor_ComparedWithMeilan_original.xlsx")



# Read source workbook for per-sheet updates
path <- "/Validation/Parameters/South_CVDriskFactor_ComparedWithMeilan.xlsx"
...
write_xlsx(result_sheets, "/Validation/Tables/South_CVDriskFactor_ComparedWithMeilan_category.xlsx")
