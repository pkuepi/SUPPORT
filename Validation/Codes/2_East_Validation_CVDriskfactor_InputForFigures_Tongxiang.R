...
data_observed <- read.xlsx("/Validation/Parameters/East_CVDriskFactor_ComparedWithTongxiang.xlsx", sheet = "original")
...
data_simulated <- read.xlsx("/Validation/Tables/East_withTongxiang_Summary_CVDriskFactor.xlsx") 
...
write_xlsx(data_observed, "/Validation/Tables/East_CVDriskFactor_ComparedWithTongxiang_original.xlsx")



# Read source workbook for per-sheet updates
path <- "/Validation/Parameters/East_CVDriskFactor_ComparedWithTongxiang.xlsx"
...
write_xlsx(result_sheets, "/Validation/Tables/East_CVDriskFactor_ComparedWithTongxiang_category.xlsx")
