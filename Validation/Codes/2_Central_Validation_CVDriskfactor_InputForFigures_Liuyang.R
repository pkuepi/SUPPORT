...
data_observed <- read.xlsx("/Validation/Parameters/Central_CVDriskFactor_ComparedWithLiuyang.xlsx", sheet = "original")
...
data_simulated <- read.xlsx("/Validation/Tables/Central_withLiuyang_Summary_CVDriskFactor.xlsx") 
...
write_xlsx(data_observed, "/Validation/Tables/Central_CVDriskFactor_ComparedWithLiuyang_original.xlsx")



# Read source workbook for per-sheet updates
path <- "/Validation/Parameters/Central_CVDriskFactor_ComparedWithLiuyang.xlsx"
...
write_xlsx(result_sheets, "/Validation/Tables/Central_CVDriskFactor_ComparedWithLiuyang_category.xlsx")
