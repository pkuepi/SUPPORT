...
data_observed <- read.xlsx("/Validation/Parameters/Southwest_CVDriskFactor_ComparedWithPengzhou.xlsx", sheet = "original")
...
data_simulated <- read.xlsx("/Validation/Tables/Southwest_withPengzhou_Summary_CVDriskFactor.xlsx") 
...
write_xlsx(data_observed, "/Validation/Tables/Southwest_CVDriskFactor_ComparedWithPengzhou_original.xlsx")



# Read source workbook for per-sheet updates
path <- "/Validation/Parameters/Southwest_CVDriskFactor_ComparedWithPengzhou.xlsx"
...
write_xlsx(result_sheets, "/Validation/Tables/Southwest_CVDriskFactor_ComparedWithPengzhou_category.xlsx")
