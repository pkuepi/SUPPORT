...
# Southwest
# Please use the dataset downloaded from https://zenodo.org/records/17406896 as the input
# =========================
#======================== Basic setting ========================#
rm(list = ls())
gc()
...
input_path <- file.path(base_path, "/SUPPORT/Southwest_synpop.rda")
...
# Output
output_path <- "/Validation/Tables/Southwest_withPengzhou_Summary_CVDriskFactor.xlsx"
