...
data_observed <- read.xlsx("/Validation/Parameters/Central_CVDriskFactor_ComparedWithHuixian.xlsx", sheet = "original")
...
data_simulated <- read.xlsx("/Validation/Tables/Central_withHuixian_Summary_CVDriskFactor.xlsx") 
...
write_xlsx(data_observed, "/Validation/Tables/Central_CVDriskFactor_ComparedWithHuixian_original.xlsx")



# Read source workbook for per-sheet updates
path <- "/Validation/Parameters/Central_CVDriskFactor_ComparedWithHuixian.xlsx"
...
write_xlsx(result_sheets, "/Validation/Tables/Central_CVDriskFactor_ComparedWithHuixian_category.xlsx")
