...
female_path <- file.path(base_path, "Northwest_SBP_Diabetes_Female.rda")
male_path   <- file.path(base_path, "Northwest_SBP_Diabetes_Male.rda")
output_path <- "/Generation/Northwest_SBP_Diabetes_ALLSex.rda"
...
cat("\n=== Saving Data ===\n")
obj_name <- "Northwest_CVDriskfactor_ALLSex"
