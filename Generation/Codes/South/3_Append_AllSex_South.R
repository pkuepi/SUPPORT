...
female_path <- file.path(base_path, "South_SBP_Diabetes_Female.rda")
male_path   <- file.path(base_path, "South_SBP_Diabetes_Male.rda")
output_path <- "/Generation/South_SBP_Diabetes_ALLSex.rda"
...
cat("\n=== Saving Data ===\n")
obj_name <- "South_CVDriskfactor_ALLSex"
