...
female_path <- file.path(base_path, "North_SBP_Diabetes_Female.rda")
male_path   <- file.path(base_path, "North_SBP_Diabetes_Male.rda")
output_path <- "/Generation/North_SBP_Diabetes_ALLSex.rda"
...
cat("\n=== Saving Data ===\n")
obj_name <- "North_CVDriskfactor_ALLSex"
