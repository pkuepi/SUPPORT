...
female_path <- file.path(base_path, "Northeast_SBP_Diabetes_Female.rda")
male_path   <- file.path(base_path, "Northeast_SBP_Diabetes_Male.rda")
output_path <- "/Generation/Northeast_SBP_Diabetes_ALLSex.rda"
...
cat("\n=== Saving Data ===\n")
obj_name <- "Northeast_CVDriskfactor_ALLSex"
