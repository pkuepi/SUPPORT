...
female_path <- file.path(base_path, "East_SBP_Diabetes_Female.rda")
male_path   <- file.path(base_path, "East_SBP_Diabetes_Male.rda")
output_path <- "/Generation/East_SBP_Diabetes_ALLSex.rda"
...
cat("\n=== Saving Data ===\n")
obj_name <- "East_CVDriskfactor_ALLSex"
