...
female_path <- file.path(base_path, "Central_SBP_Diabetes_Female.rda")
male_path   <- file.path(base_path, "Central_SBP_Diabetes_Male.rda")
output_path <- "/Generation/Central_SBP_Diabetes_ALLSex.rda"
...
cat("\n=== Saving Data ===\n")
obj_name <- "Central_CVDriskfactor_ALLSex"
